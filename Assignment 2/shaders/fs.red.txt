...
uniform vec3 emissiveColour = {1,0,0};
uniform vec3 ambientColour  = {1.0f,0.0f,0.0f};
uniform vec3 diffuseColour  = {1.0f,0.0f,0.0f};
uniform vec3 specularColour = {1.0f,0.0f,0.0f};
